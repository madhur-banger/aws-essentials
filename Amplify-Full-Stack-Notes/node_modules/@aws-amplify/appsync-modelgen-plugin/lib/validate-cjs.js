...
function validate65(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
        for (const key0 in data) {
            const _errs2 = errors;
            if (!(validate43(data[key0], { instancePath: instancePath + "/" + key0.replace(/~/g, "~0").replace(/\//g, "~1"), parentData: data, parentDataProperty: key0, rootData }))) {
...
const schema45 = { "type": "object", "additionalProperties": { "$ref": "#/definitions/SchemaConversationRoute" } };
const schema46 = { "type": "object", "properties": { "name": { "type": "string" }, "models": { "$ref": "#/definitions/SchemaModels" }, "nonModels": { "$ref": "#/definitions/SchemaNonModels" }, "enums": { "$ref": "#/definitions/SchemaEnums" }, "conversation": { "$ref": "#/definitions/SchemaConversation" }, "message": { "$ref": "#/definitions/SchemaConversationMessage" } }, "required": ["name", "models", "nonModels", "enums", "conversation", "message"], "additionalProperties": false };
const schema47 = { "type": "object", "properties": { "modelName": { "type": "string" } }, "required": ["modelName"], "additionalProperties": false };
const schema48 = { "type": "object", "properties": { "modelName": { "type": "string" }, "subscribe": { "$ref": "#/definitions/SchemaSubscription" }, "send": { "$ref": "#/definitions/SchemaMutation" } }, "required": ["modelName", "subscribe", "send"], "additionalProperties": false };
function validate73(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
        let missing0;
        if ((((data.modelName === undefined) && (missing0 = "modelName")) || ((data.subscribe === undefined) && (missing0 = "subscribe"))) || ((data.send === undefined) && (missing0 = "send"))) {
            ...
            const _errs1 = errors;
            for (const key0 in data) {
                if (!(((key0 === "modelName") || (key0 === "subscribe")) || (key0 === "send"))) {
            ...
            if (_errs1 === errors) {
                if (data.modelName !== undefined) {
                    ...
                    if (typeof data.modelName !== "string") {
                        validate73.errors = [{ instancePath: instancePath + "/modelName", schemaPath: "#/properties/modelName/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                        return false;
                    }
                    var valid0 = _errs2 === errors;
                }
                ...
                if (valid0) {
                    if (data.subscribe !== undefined) {
                        const _errs4 = errors;
                        if (!(validate55(data.subscribe, { instancePath: instancePath + "/subscribe", parentData: data, parentDataProperty: "subscribe", rootData }))) {
                            vErrors = vErrors === null ? validate55.errors : vErrors.concat(validate55.errors);
                            errors = vErrors.length;
                        }
                        var valid0 = _errs4 === errors;
                    ...
                    if (valid0) {
                        if (data.send !== undefined) {
                            const _errs5 = errors;
                            if (!(validate49(data.send, { instancePath: instancePath + "/send", parentData: data, parentDataProperty: "send", rootData }))) {
                                vErrors = vErrors === null ? validate49.errors : vErrors.concat(validate49.errors);
                                errors = vErrors.length;
                            }
                            var valid0 = _errs5 === errors;
...
function validate69(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
        let missing0;
        if (((((((data.name === undefined) && (missing0 = "name")) || ((data.models === undefined) && (missing0 = "models"))) || ((data.nonModels === undefined) && (missing0 = "nonModels"))) || ((data.enums === undefined) && (missing0 = "enums"))) || ((data.conversation === undefined) && (missing0 = "conversation"))) || ((data.message === undefined) && (missing0 = "message"))) {
            ...
            const _errs1 = errors;
            for (const key0 in data) {
                if (!((((((key0 === "name") || (key0 === "models")) || (key0 === "nonModels")) || (key0 === "enums")) || (key0 === "conversation")) || (key0 === "message"))) {
                            ...
                            if (valid0) {
                                if (data.conversation !== undefined) {
                                    ...
                                    if (errors === _errs8) {
                                        if (data4 && typeof data4 == "object" && !Array.isArray(data4)) {
                                            let missing1;
                                            if ((data4.modelName === undefined) && (missing1 = "modelName")) {
                                                validate69.errors = [{ instancePath: instancePath + "/conversation", schemaPath: "#/definitions/SchemaConversation/required", keyword: "required", params: { missingProperty: missing1 }, message: "must have required property '" + missing1 + "'" }];
                                                return false;
                                            }
                                            else {
                                                const _errs10 = errors;
                                                for (const key1 in data4) {
                                                    if (!(key1 === "modelName")) {
                                                        validate69.errors = [{ instancePath: instancePath + "/conversation", schemaPath: "#/definitions/SchemaConversation/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key1 }, message: "must NOT have additional properties" }];
                                                        return false;
                                                        break;
                                                    }
                                                }
                                                if (_errs10 === errors) {
                                                    if (data4.modelName !== undefined) {
                                                        if (typeof data4.modelName !== "string") {
                                                            validate69.errors = [{ instancePath: instancePath + "/conversation/modelName", schemaPath: "#/definitions/SchemaConversation/properties/modelName/type", keyword: "type", params: { type: "string" }, message: "must be string" }];
                                                            return false;
                                                        }
                                                    }
                                                }
                                            ...
                                            validate69.errors = [{ instancePath: instancePath + "/conversation", schemaPath: "#/definitions/SchemaConversation/type", keyword: "type", params: { type: "object" }, message: "must be object" }];
                                            return false;
                                        }
                                    }
                                    var valid0 = _errs7 === errors;
                                ...
                                if (valid0) {
                                    if (data.message !== undefined) {
                                        const _errs13 = errors;
                                        if (!(validate73(data.message, { instancePath: instancePath + "/message", parentData: data, parentDataProperty: "message", rootData }))) {
...
function validate68(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) { let vErrors = null; let errors = 0; if (errors === 0) {
    if (data && typeof data == "object" && !Array.isArray(data)) {
        for (const key0 in data) {
            const _errs2 = errors;
            if (!(validate69(data[key0], { instancePath: instancePath + "/" + key0.replace(/~/g, "~0").replace(/\//g, "~1"), parentData: data, parentDataProperty: key0, rootData }))) {
                                        ...
                                        if (valid0) {
                                            ...
                                            if (valid0) {
                                                if (data.generations !== undefined) {
                                                    const _errs11 = errors;
                                                    if (!(validate65(data.generations, { instancePath: instancePath + "/generations", parentData: data, parentDataProperty: "generations", rootData }))) {
                                                ...
                                                if (valid0) {
                                                    if (data.conversations !== undefined) {
                                                        const _errs12 = errors;
                                                        if (!(validate68(data.conversations, { instancePath: instancePath + "/conversations", parentData: data, parentDataProperty: "conversations", rootData }))) {
