...
const isPostgresModel = (ctx, typename) => {
    if ((0, graphql_utils_1.isBuiltInGraphqlType)(typename)) {
        return false;
    }
    const modelDataSourceType = (0, exports.getModelDataSourceStrategy)(ctx, typename);
    return (0, exports.isPostgresDbType)(modelDataSourceType.dbType);
};
exports.isPostgresModel = isPostgresModel;
const isPostgresDbType = (dbType) => {
    return dbType === types_1.POSTGRES_DB_TYPE;
};
exports.isPostgresDbType = isPostgresDbType;
