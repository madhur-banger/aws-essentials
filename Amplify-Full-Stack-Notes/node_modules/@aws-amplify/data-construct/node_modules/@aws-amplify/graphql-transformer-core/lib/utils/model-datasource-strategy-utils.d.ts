...
export declare const isPostgresModel: (ctx: DataSourceStrategiesProvider, typename: string) => boolean;
export declare const isPostgresDbType: (dbType: ModelDataSourceStrategyDbType) => dbType is "POSTGRES";
