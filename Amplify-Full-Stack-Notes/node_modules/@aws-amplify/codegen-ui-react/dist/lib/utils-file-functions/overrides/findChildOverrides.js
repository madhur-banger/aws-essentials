...
exports.findChildOverridesString = exports.findChildOverrides = void 0;
/**
 ...
 */
const findChildOverrides = (overrides, elementHierarchy) => {
    if (!overrides) {
        return null;
    }
    const filteredOverrides = Object.entries(overrides).filter((m) => m[0].startsWith(elementHierarchy));
    return Object.assign({}, ...Array.from(filteredOverrides, ([k, v]) => ({
        [k.replace(elementHierarchy, '')]: v,
    })));
};
exports.findChildOverrides = findChildOverrides;
exports.findChildOverridesString = `export const findChildOverrides = (
...
//# sourceMappingURL=findChildOverrides.js.map