...
exports.generateValidationFunction = exports.parseDateValidator = exports.validateField = void 0;
/* eslint-disable */
...
const validateField = (value, validations) => {
    for (const validation of validations) {
        ...
        if (validationResult === null || validationResult === void 0 ? void 0 : validationResult.hasError) {
...
const parseDateValidator = (dateValidator) => {
...
exports.parseDateValidator = parseDateValidator;
const checkValidation = (value, validation) => {
    var _a, _b;
    if ((_a = validation.numValues) === null || _a === void 0 ? void 0 : _a.length) {
        switch (validation.type) {
            case 'LessThanChar':
                return {
                    hasError: !(value.length <= validation.numValues[0]),
                    errorMessage: validation.validationMessage || `The value must be ${validation.numValues[0]} characters or fewer`,
                };
            case 'GreaterThanChar':
                return {
                    hasError: !(value.length > validation.numValues[0]),
                    errorMessage: validation.validationMessage || `The value must be at least ${validation.numValues[0]} characters`,
                };
            case 'LessThanNum':
                return {
    ...
    else if ((_b = validation.strValues) === null || _b === void 0 ? void 0 : _b.length) {
        switch (validation.type) {
            case 'StartWith':
                return {
            ...
            case 'BeAfter':
                return {
                    hasError: !(new Date(value) > new Date((0, exports.parseDateValidator)(validation.strValues[0]))),
...
const generateValidationFunction = () => {
    return [
        (0, validation_helpers_1.validationResponseDeclaration)(),
        (0, validation_helpers_1.fieldValidationConfigurationDeclaration)(),
        (0, validation_helpers_1.generateValidateFieldFunction)(),
        (0, validation_helpers_1.generateParseDateValidatorFunction)(),
        (0, validation_helpers_1.generateCheckValidationFunction)(),
    ];
};
