...
exports.validateViewSchema = exports.validateFormSchema = exports.validateThemeSchema = exports.validateComponentSchema = void 0;
/*
...
const propertiesSchema = (value) => {
    return yup.object().shape(Object.fromEntries(Object.keys(value || {}).map((key) => [
        key,
        yup
            .object()
            .test('property', 'property cannot be empty.', (property) => Object.keys(property).length > 0)
            .required(),
    ])));
};
...
const schemaVersionSchema = () => {
    ...
    return (yup
        ...
        .test('schemaVersion', 'unsupported schemaVersion ${originalValue}', (value) => {
        if (value === undefined) {
            return true;
        }
 ...
 */
const studioComponentChildSchema = yup.object({
 ...
 */
const studioThemeValuesSchema = yup.object({
 ...
 */
const validateSchema = (validator, studioSchema) => {
    try {
...
const validateComponentSchema = (schema) => validateSchema(studioComponentSchema, schema);
exports.validateComponentSchema = validateComponentSchema;
const validateThemeSchema = (schema) => validateSchema(studioThemeSchema, schema);
exports.validateThemeSchema = validateThemeSchema;
const validateFormSchema = (schema) => validateSchema(studioFormSchema, schema);
exports.validateFormSchema = validateFormSchema;
const validateViewSchema = (schema) => validateSchema(studioViewSchema, schema);
exports.validateViewSchema = validateViewSchema;
