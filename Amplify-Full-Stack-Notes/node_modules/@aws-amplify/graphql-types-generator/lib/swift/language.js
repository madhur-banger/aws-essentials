...
exports.SwiftGenerator = exports.escapeIdentifierIfNeeded = exports.escapedString = void 0;
...
class SwiftGenerator extends CodeGenerator_1.CodeGenerator {
    constructor(context) {
        super(context);
    }
    ...
    classDeclaration({ className, modifiers, superClass, adoptedProtocols = [] }, closure) {
        this.printNewlineIfNeeded();
        this.printOnNewline((0, printing_1.wrap)('', (0, printing_1.join)(modifiers, ' '), ' ') + `class ${className}`);
        this.print((0, printing_1.wrap)(': ', (0, printing_1.join)([superClass, ...adoptedProtocols], ', ')));
    ...
    structDeclaration({ structName, description, adoptedProtocols = [] }, closure) {
        ...
        this.print((0, printing_1.wrap)(': ', (0, printing_1.join)(adoptedProtocols, ', ')));
