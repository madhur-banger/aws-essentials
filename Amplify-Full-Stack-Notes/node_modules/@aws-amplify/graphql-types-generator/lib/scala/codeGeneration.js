...
exports.typeDeclarationForGraphQLType = exports.caseClassDeclarationForSelectionSet = exports.caseClassDeclarationForFragment = exports.classDeclarationForOperation = exports.generateSource = void 0;
...
function generateSource(context, options) {
    ...
    if (context.namespace) {
        (0, language_1.packageDeclaration)(generator, context.namespace);
    }
    ...
    (0, language_1.objectDeclaration)(generator, {
        ...
        if (fragmentsReferenced && fragmentsReferenced.length > 0) {
            ...
            fragmentsReferenced.forEach(fragment => {
                generator.print(` + ${(0, naming_1.caseClassNameForFragmentName)(fragment)}.fragmentString`);
            });
            generator.print(' }');
        ...
        if (variables && variables.length > 0) {
            const properties = variables.map(({ name, type }) => {
                ...
                const typeName = (0, types_1.typeNameFromGraphQLType)(generator.context, type);
...
function caseClassDeclarationForFragment(generator, { fragmentName, typeCondition, fields, inlineFragments, fragmentSpreads, source }) {
    const caseClassName = (0, naming_1.caseClassNameForFragmentName)(fragmentName);
    caseClassDeclarationForSelectionSet(generator, {
        caseClassName,
...
function caseClassDeclarationForInputObjectType(generator, type) {
    ...
    const properties = fields.map(field => (0, naming_1.propertyFromField)(generator.context, field));
    (0, language_1.caseClassDeclaration)(generator, {
        caseClassName,
        description,
        params: properties.map(p => {
