...
exports.propertyDeclarations = exports.propertyFromField = exports.propertiesFromFields = exports.typeDeclarationForFragment = exports.typeDeclarationForOperation = exports.interfaceVariablesDeclarationForOperation = exports.typeDeclarationForGraphQLType = exports.generateSource = void 0;
...
function structDeclarationForInputObjectType(generator, type) {
    ...
    (0, language_1.typeDeclaration)(generator, {
        interfaceName,
    }, () => {
...
function propertyDeclarations(generator, properties, isOptional) {
    if (!properties)
        return;
...
function getPossibleTypeNames(generator, property) {
    return generator.context.schema.getPossibleTypes((0, graphql_1.getNamedType)(property.fieldType || property.type)).map(type => type.name);
}
