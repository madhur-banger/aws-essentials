...
exports.propertySetsDeclaration = exports.propertyDeclaration = exports.typeDeclaration = void 0;
...
function propertyDeclaration(generator, { fieldName, type, propertyName, typeName, description, isArray, isNullable, isArrayElementNullable, fragmentSpreads, isOptional }, closure, open = ' {|', close = '|}') {
    ...
    if (closure) {
        ...
        generator.print(`: ${typeName || (0, types_1.typeNameFromGraphQLType)(generator.context, type)}`);
    }
    generator.print(',');
}
...
function propertySetsDeclaration(generator, property, propertySets, standalone = false) {
    ...
    generator.withinBlock(() => {
        propertySets.forEach((propertySet, index, propertySets) => {
            generator.withinBlock(() => {
                (0, codeGeneration_1.propertyDeclarations)(generator, propertySet);
            });
