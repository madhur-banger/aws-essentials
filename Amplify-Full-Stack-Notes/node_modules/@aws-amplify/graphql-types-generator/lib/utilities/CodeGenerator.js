...
exports.CodeGenerator = exports.GeneratedFile = exports.isBasicGeneratedFileMap = void 0;
function isBasicGeneratedFileMap(output) {
    return typeof output === 'object';
}
exports.isBasicGeneratedFileMap = isBasicGeneratedFileMap;
class GeneratedFile {
    constructor() {
        this.scopeStack = [];
        this.indentWidth = 2;
