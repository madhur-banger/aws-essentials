...
exports.compileToIR = void 0;
const graphql_1 = require("graphql");
const graphql_2 = require("../utilities/graphql");
function compileToIR(schema, document, options = {}) {
    if (options.addTypename) {
        document = (0, graphql_2.withTypenameFieldAddedWhereNeeded)(document);
    }
...
class Compiler {
    ...
    addTypeUsed(type) {
        ...
        if ((0, graphql_1.isInterfaceType)(type) || (0, graphql_1.isUnionType)(type)) {
            for (const concreteType of this.schema.getPossibleTypes(type)) {
                this.addTypeUsed((0, graphql_1.getNamedType)(concreteType));
            }
        }
        ...
        if ((0, graphql_1.isObjectType)(type)) {
            for (const fieldType of type.getInterfaces()) {
                this.addTypeUsed((0, graphql_1.getNamedType)(fieldType));
            }
            for (const field of Object.values(type.getFields())) {
                this.addTypeUsed((0, graphql_1.getNamedType)(field.type));
            }
    ...
    compileOperation(operationDefinition) {
        ...
        this.addTypeUsed((0, graphql_1.getNamedType)(selectionSet.selections[0].type));
        return {
            filePath,
            operationName,
            operationType,
    ...
    compileSelection(selectionNode, parentType, possibleTypes, visitedFragments) {
        switch (selectionNode.kind) {
            ...
            case graphql_1.Kind.INLINE_FRAGMENT: {
                ...
                const type = typeNode ? (0, graphql_1.typeFromAST)(this.schema, typeNode) : parentType;
