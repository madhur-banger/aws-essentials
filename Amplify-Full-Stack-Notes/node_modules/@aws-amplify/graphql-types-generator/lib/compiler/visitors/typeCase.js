...
exports.TypeCase = exports.typeCaseForSelectionSet = exports.Variant = void 0;
...
class Variant {
    ...
    get fields() {
        return (0, collectAndMergeFields_1.collectAndMergeFields)(this);
    }
    inspect() {
        return `${(0, util_1.inspect)(this.possibleTypes)} -> ${(0, util_1.inspect)((0, collectAndMergeFields_1.collectAndMergeFields)(this, false).map(field => field.responseKey))} ${(0, util_1.inspect)(this.fragmentSpreads.map(fragmentSpread => fragmentSpread.fragmentName))}\n`;
    }
}
