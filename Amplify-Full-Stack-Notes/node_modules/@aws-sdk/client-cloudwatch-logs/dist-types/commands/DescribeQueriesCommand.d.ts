...
declare const DescribeQueriesCommand_base: {
    new (input: DescribeQueriesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeQueriesCommandInput, DescribeQueriesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeQueriesCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeQueriesCommandInput, DescribeQueriesCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
