...
declare const ListLogAnomalyDetectorsCommand_base: {
    new (input: ListLogAnomalyDetectorsCommandInput): import("@smithy/smithy-client").CommandImpl<ListLogAnomalyDetectorsCommandInput, ListLogAnomalyDetectorsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListLogAnomalyDetectorsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListLogAnomalyDetectorsCommandInput, ListLogAnomalyDetectorsCommandOutput, CloudWatchLogsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
